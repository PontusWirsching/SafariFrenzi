...
public class CoinBronze extends Collectible {

	public Vector2 origin;

	public CoinBronze(float x, float y, float w, float h, Vector2 v) {
		super(x, y, w, h);
		...
		addFrame(Resources.get("coin:bronze:1_shadow"));
		addFrame(Resources.get("coin:bronze:2_shadow"));
		addFrame(Resources.get("coin:bronze:3_shadow"));
		addFrame(Resources.get("coin:bronze:4_shadow"));
		addFrame(Resources.get("coin:bronze:5_shadow"));
		addFrame(Resources.get("coin:bronze:6_shadow"));
		addFrame(Resources.get("coin:bronze:7_shadow"));
		addFrame(Resources.get("coin:bronze:8_shadow"));
	...
	public CoinBronze(float x, float y, float w, float h) {
		super(x, y, w, h);
		origin = new Vector2(position);
		setID("VALUEABLE");
	...
	class CoinSprite extends Sprite {
		...
		public CoinSprite(String id, float x, float y, float width, float height) {
			...
			frames.add(new TextureRegion(Resources.get("coin:bronze:1")));
			frames.add(new TextureRegion(Resources.get("coin:bronze:2")));
			frames.add(new TextureRegion(Resources.get("coin:bronze:3")));
			frames.add(new TextureRegion(Resources.get("coin:bronze:4")));
			frames.add(new TextureRegion(Resources.get("coin:bronze:5")));
			frames.add(new TextureRegion(Resources.get("coin:bronze:6")));
			frames.add(new TextureRegion(Resources.get("coin:bronze:7")));
			frames.add(new TextureRegion(Resources.get("coin:bronze:8")));
